...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Sce Fruit Blox Hub Srcipt Folder') then
        makefolder('Sce Fruit Blox Hub Srcipt Folder')
    end
    if not _G.Dis and not isfile('Sce Fruit Blox HubSrcipt Folder/'..Name..'.json') then
        writefile('Sce Fruit Blox Hub Srcipt Folder/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Sce Fruit Blox Hub Srcipt Folder') and isfile('Sce Fruit Blox Hub Srcipt Folder/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Sce Fruit Blox Hub Srcipt Folder/'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Sce Fruit Blox Hub Srcipt Folder') and isfile('Sce Fruit Blox HubSrcipt Folder/'..Name..'.json') then
        writefile('Sce Fruit Blox Hub Srcipt Folder/'..Name..'.json',JsonEncode(_G.Setting_table))
    elseif not _G.Dis then
        Check_Setting(Name)
    end
...
SOMEXHUBMODILE.Name = "sce blox fruit hub"
    ...
    game.CoreGui:FindFirstChild("sce blox fruit hub").Enabled = not game.CoreGui:FindFirstChild("sce blox fruit hub").Enabled
    end)
    do
    if game:GetService("CoreGui"):FindFirstChild("sce blox fruit hub") then
    end
    end

    MODILEGUISOMEXHUBHUI.Name = "sce blox fruit hub"
    MODILEGUISOMEXHUBHUI.Parent = MODILEGUISOMEXHUB

    MODILEMAGE.Name = "sce blox fruit hub"
...
do local GUI = game.CoreGui:FindFirstChild("sce blox fruit hub");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
SOMEXHUB.Name = "sce blox fruit hub"
